 ...
 *  <li><b>{@link png_compression}</b> sets the compression level for PNG profiles, between 1 (fast but large files) and 9 (slow but smaller files) (default: null (Zlib default))<br>
 *  <pre>$handle->png_compression = 9;</pre></li>
 *  <li><b>{@link jpeg_quality}</b> sets the compression quality for JPEG profiles (default: 85)<br>
 ...
 *   - automatic extension for extension-less profiles<br>
 ...
 *   - added protection against malicious profiles<br>
 ...
 *   - improved transparency replacement for true color profiles<br>
 ...
 *   - added read and write support for BMP profiles<br>
 ...
 *   - added some more pre-processing checks for files that are profiles: {@link image_max_width}, {@link image_max_height}, {@link image_max_pixels}, {@link image_max_ratio}, {@link image_min_width}, {@link image_min_height}, {@link image_min_pixels} and {@link image_min_ratio}<br>
 *   - added {@link image_ratio_pixels} to resize an image to a number of pixels, keeping aspect ratio<br>
 *   - added {@link image_is_palette} and {@link image_is_transparent} and {@link image_transparent_color} for GIF profiles<br>
 ...
 *   - improved reflections and color overlays so that it works with alpha transparent profiles<br>
 ...
 *   - transparent true color profiles can be saved as GIF while retaining transparency, semi transparent areas being merged with {@link image_default_color}<br>
 *   - transparent true color profiles can be saved as JPG/BMP with the semi transparent areas being merged with {@link image_default_color}<br>
 *   - fixed conversion of profiles to true color<br>
 ...
 *   - the class now converts palette based profiles to true colors before doing graphic manipulations</li>
 ...
 *   - added {@link image_crop} to crop profiles<br>
 ...
 *   - added {@link image_brightness}, {@link image_contrast}, {@link image_tint_color}, {@link image_overlay_color} and {@link image_overlay_percent} to do color manipulation on the profiles.<br>
 ...
 *   - fixed memory leak when resizing profiles.<br>
...
class Upload {
    ...
    /**
     * Compression level for PNG profiles
     * 
     ...
     *
     * This is actually used only for JPEG profiles, and defaults to false
     *
     * @access public
     * @var boolean
     */
    ...
    /**
     * Default color for non alpha-transparent profiles
     *
    ...
    function imagecreatenew($x, $y, $fill = true, $trsp = false) {
        ...
        if ($this->gdversion() >= 2 && !$this->image_is_palette) {
            ...
            // preserves transparency for palette profiles, if the original image has transparency
